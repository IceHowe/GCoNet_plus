...
if __name__ == '__main__':
    ...
    parser.add_argument('--size',
                        ...
                        help='input size')
    parser.add_argument(
        '--ckpt', default='/gemini/output/ckpt/gconet/final.pth', type=str, help='model folder')
    parser.add_argument(
        '--pred_dir', default='/gemini/output/preds/GCoNet_ext', type=str, help='Output folder')
